...
function ui_convert_value(amount) --format very long numbers
    ...
    else --we are above a meg, divide by 100,000 so the decimal is shifted, floor the result to throw away everything after the decimal, divide by 10 to put the decimal in the right spot
...
function ui_color_percent(num_cur, num_max)
    local color_grad = {[0] = "#800000", [1] = "#801a00", [2] = "#803400", [3] = "#804e00", [4] = "#806800", [5] = "#808000", [6] = "#668000", [7] = "#4c8000", [8] = "#328000", [9] = "#008000", [10] = "#FFFFFF"}
